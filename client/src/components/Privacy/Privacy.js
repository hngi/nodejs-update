...
const Privacy = () => {
  return (
    <div>
      <section id='s1-header' className='p-container'>
        {/* <nav className='p-nav'>
        ...
        <div className='phead'>
          ...
          <p className='cool-btn'>Updated October 19, 2019</p>
        </div>
      </section>
      {/*Privacy Policy*/}
      <section id='s2-body' className='p-container'>
        <article className='privacy-policy'>
          <p>
            At xshare, accessible from{' '}
            <a href='https://x-share.herokuapp.com/'>here</a>, one of our main
            priorities is the privacy of our visitors. This Privacy Policy
            document contains types of information that is collected and
            recorded by Xshare and how we use it. If you have additional
            questions or require more information about our Privacy Policy, do
            not hesitate to contact us through email at help.xshare@hng.tech
          </p>
          <br />
          <h3>Log Files</h3>
          <br />
          <p>
            Xshare follows a standard procedure of using log files. These
          ...
          <p>
            ...
            the advertising partners of Xshare. Our Privacy Policy was created
          ...
          <p>
            ...
            respective advertisements and links that appear on Xshare, which
            ...
            you visit. Note that Xshare has no access to or control over these
          ...
          <br />
          <p>
            Xshare's Privacy Policy does not apply to other advertisers or
          ...
          <br />
          <p>
            Xshare does not knowingly collect any Personal Identifiable
          ...
          <p>
            ...
            that they shared and/or collect in Xshare. This policy is not
