...
const Upload = ({ uploadFile, setAlert }) => {
  ...
  const upload = () => {
    if (file === '' || file === undefined || file === null) {
      ...
      file.name.match(
        /.(jpeg|jpg|png|gif|mp4|mp3|fig|doc|docx|pdf|xlsx|avi|flv|mkv|ico|xml|exe)$/
      )
    ) {
      ...
      setFormData({ show: false });
      setAlert(
        'Only .mp4 .mp3 .avi .flv .mkv .png .jpg .jpeg .doc .docx .pdf .gif .ico .xml .exe files are supported',
        'danger'
      );
    }
  };
              ...
              {isDragActive ? (
                ...
                <>
                  ...
                  <p className='right-section-content pl-4 pr-4'>
                    ...
                    .jpg .jpeg .doc .docx .pdf .gif .ico .xml .exe files are
                    supported)
                  </p>
                </>
              )}
